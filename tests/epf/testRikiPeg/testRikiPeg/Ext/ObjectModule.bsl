...
Процедура ЗаполнитьНаборТестов(НаборТестов, КонтекстЯдраПараметр) Экспорт
	...
	НаборТестов.Добавить("ТестДолжен_ВыполнитьПроверку_lookahead_pos");
	НаборТестов.Добавить("ТестДолжен_ВыполнитьПроверку_lookahead_neg");
	НаборТестов.НачатьГруппу("Модификаторы");
	НаборТестов.Добавить("ТестДолжен_ВыполнитьПроверку_binding_pos");
	НаборТестов.Добавить("ТестДолжен_ВыполнитьПроверку_binding_neg");
	НаборТестов.Добавить("ТестДолжен_ВыполнитьПроверку_code_pos");
	НаборТестов.Добавить("ТестДолжен_ВыполнитьПроверку_code_neg");
